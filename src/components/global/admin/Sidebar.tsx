                        ...
                        <ul className="menu p-4 space-y-2">
                          <li>
                            <Link href="/dashboard/lessons">
                              <div className={`flex gap-2 items-center ${currentRoute !== '/dashboard/lessons' ? 'font-bold text-[18px]' : ''}`}>
                                <FaBook /> Lessons
                              </div>
                            </Link>
                          </li>
                          <li>
                            <Link href="/dashboard/add_lessons">
                            <div className={`flex  gap-2 items-center ${currentRoute === '/dashboard/add_lessons' ? 'font-bold' : ''}`}>
                          ...
                          <li>
                            <Link href="/dashboard/add_vocabularies">

                            <div className={`flex  gap-2 items-center ${currentRoute === '/dashboard/add_vocabularies' ? 'font-bold' : ''}`} >
                                <FaPlus /> Add Vocabularies
                            </div>
                            </Link>
                          </li>
                          <li>
                            <Link href="/dashboard/manage_users">

                            <div className={`flex  gap-2 items-center ${currentRoute === '/dashboard/manage_user' ? 'font-bold' : ''}`} >
                          ...
                          <li>
                            <Link href="/dashboard/lesson_management">
                            <div className={`flex  gap-2 items-center ${currentRoute === '/dashboard/manage_lesson' ? 'font-bold' : ''}`} >
                          ...
                          <li>
                            <Link href="/dashboard/vocabulary_management">
                            <div className={`flex  gap-2 items-center ${currentRoute === '/dashboard/manage_vocabulary' ? 'font-bold' : ''}`} >
